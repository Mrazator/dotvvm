...
namespace DotVVM.Framework.Controls
{
    ...
    public class HtmlGenericControl : DotvvmControl, IControlWithHtmlAttributes
    {
        ...
        public static DotvvmPropertyGroup StylePropertiesGroupDescriptor =
            DotvvmPropertyGroup.Register<object, HtmlGenericControl>("Style-", nameof(StyleProperties));
        ...
        {
            if (Attributes.Count > 0 || CssClasses.Count > 0 || StyleProperties.Count > 0 || !true.Equals(GetValueRaw(VisibleProperty)) || HasBinding(DataContextProperty))
            {
        ...
        {
            KnockoutBindingGroup stylePropertiesBindingGroup = null;
            foreach (var styleProperty in StyleProperties.Properties)
            {
                if (stylePropertiesBindingGroup == null) stylePropertiesBindingGroup = new KnockoutBindingGroup();
                stylePropertiesBindingGroup.Add(styleProperty.GroupMemberName, this, styleProperty);
            ...
            if (stylePropertiesBindingGroup != null)
            {
                writer.AddKnockoutDataBind("style", stylePropertiesBindingGroup);
            }
        }
